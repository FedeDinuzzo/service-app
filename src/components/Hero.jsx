...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStartHero} flex-col xl:px-0 sm:px-16 px-6 -my-12`}>
      ...
      <div className="flex flex-row justify-between items-center w-full">
        ...
        <h1 className="flex-1 font-poppins font-semibold ss:text-[52px] xl:text-[68px] text-white ss:leading-[70px] xl:leading-[90px]">
    ...
    <h1 className="font-poppins font-semibold ss:text-[52px] xl:text-[68px] text-white ss:leading-[90px] leading-[70px] w-full">
        Especializado
      </h1>
    ...
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
      <div className="md:w-[14%] xl:w-[0%]"></div>
      <div className="md:w-[86%] xl:w-[100%] h-[100%] relative z-[5] pb-[640px]">
