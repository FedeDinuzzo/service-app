    ...
    <nav className="w-full flex py-6 md:py-6 justify-between items-center navbar">
      ...
      <div className="block fixed bottom-0 left-0 w-[100vw] sm:hidden">
        <div className="flex w-full h-[30px] bg-primary">
          <div className="flex justify-evenly items-center absolute bottom-0 w-[50%] h-[60px] bg-primary pt-[4px]">
            <Link to="/">
              <div className={`bg-[url('./assets/navInicio.svg')] text-center h-[30px] w-full bg-contain bg-center bg-no-repeat`} ></div>
            </Link>
            <Link to="/heladeras">
              <div className={`bg-[url('./assets/navHeladeras.svg')] text-center h-[30px] w-full bg-contain bg-center bg-no-repeat`} />
              <div className="font-poppins p-[4px] text-white text-[14px]">Heladeras</div>
            </Link>
          </div>
          <img src={wppLogo} alt="" height="68px" width="68px" className="h-[72px] absolute bottom-[12px] left-0 right-0 m-auto z-[100]"/>
          <div className="flex justify-evenly items-center absolute bottom-0 right-0 w-[50%] h-[60px] bg-primary pt-[4px]">  
            <Link to="/lavarropas">
              <div className={`bg-[url('./assets/navLavarropas.svg')] text-center h-[30px] w-full bg-contain bg-center bg-no-repeat`} />
              <div className="font-poppins p-[4px] text-white text-[14px]">Lavarropas</div>
            </Link>
            <Link to="/contacto">
              <div className={`bg-[url('./assets/navContacto.svg')] text-center h-[30px] w-full bg-contain bg-center bg-no-repeat`} />
              <div className="font-poppins p-[4px] text-white text-[14px]">Contacto</div>
            </Link>
          </div>
        </div>
      </div>      
